...
class Miner {
    constructor(blockchain, logLevel, peers) {
        this.blockchain = blockchain;
        this.logLevel = logLevel;
        this.revalidators = peers;
    }
    ...
    mine(rewardAddress, feeAddress) {
        ...
        const thread = spawn(function (input, done) {
            ...
            done(Miner.proveTrustFor(Block.fromJson(input.jsonBlock), input.difficulty));
        });
    ...
    static proveTrustFor(jsonBlock, peers) {
        ...
        // Loop 
        do {
            block.nonce = getRandomInt(100000);
