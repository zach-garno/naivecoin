...
{ // Block
    ...
    "minimumTrust":10, // minimum level of trust needed to process the block
...
class Block {
    ...
    getMinimumTrustLevel() {
        return 1;// Hard coded value for demo and testing //TODO: Make this a configurable value this.minTrust
    }
